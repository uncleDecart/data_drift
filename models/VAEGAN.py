...
class VAEGAN(LightningModule):
    def __init__(self, args: DictConfig):
        ...
        """
        super().__init__()
        self.latent_dimensions = args.arch.vaegan.latent_dimensions
        self.channels = args.arch.vaegan.channels
        self.base = args.arch.vaegan.base

        self.Encoder = Encoder(self.base, self.latent_dimensions, self.channels)
        self.Decoder = Decoder(self.base, self.latent_dimensions, self.channels)
        self.LatentDiscriminator = LatentDiscriminator(self.latent_dimensions)
        self.Discriminator = Discriminator(self.base, self.channels)
